...
- README server-side proxy guide (`@inferencesh/sdk/proxy/*`, `proxyUrl`, `INFERENCE_API_KEY`)
- README API reference for `client.apps`, `client.flows`, `client.flowRuns`, `client.engines`, and `client.chats`
