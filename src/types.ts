...
export interface KnowledgeFile {
  path: string; // "instructions.md", "references/foo.md", "scripts/bar.py"
...
export interface TaskAction {
  key: string; // Handler key (e.g., "generate-covers")
  on: string; // Status to trigger on (e.g., "completed", "failed", "*")
  params?: any; // Handler-specific parameters
}
/**
