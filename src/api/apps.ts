...
export class AppsAPI {
  ...
  async list(params?: Partial<CursorListRequest>): Promise<CursorListResponse<App>> {
    return this.http.request<CursorListResponse<App>>('get', '/apps', { params: params as Record<string, unknown> });
  }
  ...
  async listVersions(appId: string, params?: Partial<CursorListRequest>): Promise<CursorListResponse<AppVersionDTO>> {
    return this.http.request<CursorListResponse<AppVersionDTO>>('get', `/apps/${appId}/versions`, { params: params as Record<string, unknown> });
  }
